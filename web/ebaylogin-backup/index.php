...
<br><br>
<input style="width: 120px;" type="submit" name="viewToken" value="VIEW TOKEN" onclick="window.open('view_token.php?my_session=<?=$SessionID?>','_blank','toolbar=yes,scrollbars=yes,resizable=no,top=0,left=500,width=600,height=900')">
<br><br>
<input style="width: 120px;" type="submit" name="viewOrders" value="GET ORDERS" onclick="window.open('orders.php?my_session=<?=$SessionID?>','_blank','toolbar=yes,scrollbars=yes,resizable=no,top=0,left=500,width=600,height=900')">
