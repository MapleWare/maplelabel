 ...
 * ********************************************************************* */
define('APPLICATION_NAME', 'Qty_Sync');
...
require(dirname(__FILE__) . "/MarketplaceWebServiceOrders/Client.php");
require(dirname(__FILE__) . "/MarketplaceWebServiceOrders/Model/ListOrdersRequest.php");
require(dirname(__FILE__) . "/MarketplaceWebServiceOrders/Model/ListOrderItemsRequest.php");
require(dirname(__FILE__) . "/MarketplaceWebServiceOrders/Model/ListOrdersByNextTokenRequest.php");
require(dirname(__FILE__) . "/MarketplaceWebService/Client.php");
require(dirname(__FILE__) . "/MarketplaceWebService/Model/SubmitFeedRequest.php"); 
