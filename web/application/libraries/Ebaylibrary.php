...
Class Ebaylibrary
{
    ...
    */
    ...
    {
        $this->requestToken = $arr['userRequestToken'];
        $this->devID = $arr['developerID'];
        $this->appID = $arr['applicationID'];
        $this->certID = $arr['certificateID'];
        $this->compatLevel = $arr['compatabilityLevel'];
        $this->siteID = $arr['siteToUseID'];
        $this->verb = $arr['callName'];
        $this->serverUrl = $arr['serverUrl'];
    }
