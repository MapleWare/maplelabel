...
function listOrderRequest($startDate, $sellerId, $marketPlaceId, $service) {
    $request = new MarketplaceWebServiceOrders_Model_ListOrdersRequest();
    $request->setSellerId($sellerId);
    // List all orders udpated after a certain date
    $request->setCreatedAfter($startDate . "T00:00:00Z");
    //$request->setCreatedBefore($endDate . "T23:59:59Z");
    // Set the marketplaces queried in this ListOrdersRequest
    $request->setMarketplaceId(array($marketPlaceId));
